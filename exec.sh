...
CUDA_VISIBLE_DEVICES=0 python evaluation_pipeline/cal_eval.py \
...
CUDA_VISIBLE_DEVICES=0 python evaluation_pipeline/image_generation_example/generate_image_$MODEL_NAME.py \
